      ...
      <el-header style="text-align: right; font-size: 12px">
        <el-dropdown>
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item @click="create('pet')">
              <el-button @click="create('pet')">
                Pet Care
              </el-button>
            </el-dropdown-item>
            <el-dropdown-item @click="create('pet')">
              <el-button @click="create('delivery')">
                Delivery
              </el-button>
            </el-dropdown-item>
          </el-dropdown-menu>
        ...
        <el-table :data="tableData">
          ...
          <el-table-column fixed="right" label="Operation" width="100">
            <template slot-scope="scope">
              ...
              <el-button @click="deleteErrand(scope)" type="text" size="small">delete</el-button>
            </template>
          </el-table-column>
        </el-table>
...
export default {
  ...
  methods: {
    page (userId) {
      const _this = this
      this.$axios.post('/errand/list/errand', {
        userId: userId
      }).then((res) => {
    ...
    create (type) {
      if (type === 'pet') {
        this.$router.push({name: 'Pet', params: {create: true}})
      }
      if (type === 'delivery') {
        this.$router.push({name: 'Delivery', params: {create: true}})
      }
      // this.$router.go(0)
      // this.$router.push({name: 'Pet', params: {create: true}})
    }
